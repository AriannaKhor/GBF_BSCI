...
namespace GreatechApp.CompactView
{
    public class CompactShellViewModel : BindableBase
    {
        ...
        public CompactShellViewModel(IDialogService dialogService, IContainerProvider container, CultureResources cultureResources)
        {
