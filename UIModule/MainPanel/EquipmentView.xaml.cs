...
namespace UIModule.MainPanel
{
    ...
    public partial class EquipmentView : UserControl
    {
        ...
        private void EquipView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if(presentationSource != null)
                presentationSource.ContentRendered += EquipView_ContentRendered;
        }

        private void EquipView_ContentRendered(object sender, EventArgs e)
        {
            var vm = (EquipmentViewModel)this.DataContext;
            ((PresentationSource)sender).ContentRendered -= EquipView_ContentRendered;
        }
