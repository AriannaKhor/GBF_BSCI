...
{
    public class SampleSeq4 : BaseClass
    {
        #region Variable
        private SN m_SeqNum;
        ...
        #region Constructor
        public SampleSeq4(MarkerType markerType = MarkerType.None, int slotNum = 0, int stationNum = 0)
        {
...
//                            if (!Global.SeqStop)
//                            {
//                                //if(BaseData.ModuleSlots[0].IsPresent)
//                                //m_SeqNum = SN.EvalVision4sResult;
//                                m_SeqNum = SN.EOS;
//                            }
//                            break;

//                        case SN.EvalVision4sResult:
//                            // Inspection
//                            // set the inspection result to station
//                            Wait(0.5);

//#if SIMULATION
//                            if (BaseData.ModuleSlots[(int) Slot_Pos.In_Vision4S].IsPresent)
//                            {
//                                StationResult stationResult = m_Count % 2 == 0 ? StationResult.Pass : StationResult.Fail;
//                                BaseData.SetStationResult((int)Slot_Pos.In_Vision4S, TestStation.Vision4S, stationResult);
//                            }
//#endif

//                            m_SeqNum = SN.EvalTester1Result;
//                            break;

//                        case SN.EvalTester1Result:
//                            // Inspection
//                            // set the inspection result to station
//                            Wait(0.5);

//#if SIMULATION
//                            if (BaseData.ModuleSlots[(int)Slot_Pos.Tester1].IsPresent)
//                            {
//                                StationResult stationResult = m_Count % 2 == 0 ? StationResult.Pass : StationResult.Fail;
//                                BaseData.SetStationResult((int)Slot_Pos.Tester1, TestStation.Tester1, stationResult);
//                            }
//#endif
...
//                            {
//                                BaseData.TransferData(SQID.SampleSeq5, (int)Slot_Pos.Out, 0);
//                            }
